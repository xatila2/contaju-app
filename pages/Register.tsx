...
export const Register: React.FC = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Auto login logic usually handled by Supabase, but we can redirect to login or check session
        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                <div className="p-8">
                    ...
                    <h2 className="text-2xl font-bold text-center text-zinc-900 dark:text-white mb-2">Criar Conta</h2>
                    <p className="text-center text-zinc-500 dark:text-zinc-400 mb-8">Comece a organizar suas finanças hoje.</p>
